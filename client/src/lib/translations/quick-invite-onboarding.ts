...
export const quickInviteTranslations = {
  en: {
    ...
    stepOneDescription: `Share the professional details and expected consulting rate ${brandName} should review for this project application.`,
    ...
    expectedRate: "Expected Consulting Rate",
    expectedRatePlaceholder: "e.g., 500",
    expectedRateCurrency: "Currency",
  ...
  "pt-BR": {
    ...
    stepOneDescription: `Compartilhe os dados profissionais e a taxa de consultoria esperada que a ${brandName} deve avaliar para esta candidatura.`,
    ...
    expectedRate: "Taxa de Consultoria Esperada",
    expectedRatePlaceholder: "Ex: 500",
    expectedRateCurrency: "Moeda",
  ...
  es: {
    ...
    stepOneDescription: `Comparta los datos profesionales y la tarifa de consultoría esperada que ${brandName} debe evaluar para esta solicitud.`,
    ...
    expectedRate: "Tarifa de Consultoría Esperada",
    expectedRatePlaceholder: "Ej: 500",
    expectedRateCurrency: "Moneda",
