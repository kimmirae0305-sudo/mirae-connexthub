...
- **Data Model**: Core entities include Projects, Experts, Vetting Questions, Project Experts, Call Records, and Usage Records. Key attributes support project management, expert profiling, and KPI calculations (e.g., `cuRatePerCU`, `sourcedByRaId`).
...
- **Enhanced Project Management**: Redesigned project detail page (`/projects/:id`) with tabbed navigation:
    ...
    - **Existing Experts**: Manage internal experts, track invitation statuses (`not_invited` to `declined`), generate invite links, and bulk operations.
